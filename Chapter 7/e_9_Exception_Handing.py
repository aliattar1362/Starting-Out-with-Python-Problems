...
def main():
    # Define the condition for normal and exception condition.
    try:
        ...
        print('ERROR: There  are problems in ', end = "")
        print('reading items from the file ', end = "")
        print('that are converted to a number.')
